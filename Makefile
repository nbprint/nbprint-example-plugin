...
test:  ## run python tests
	python -m pytest -v nbprint_example_plugin/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_example_plugin/tests --cov=nbprint_example_plugin --cov-report term-missing --cov-report xml
